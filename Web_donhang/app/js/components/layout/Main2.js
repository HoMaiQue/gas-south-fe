...
class Main2 extends React.Component {
    ...
    handleOpen() {
        $("body")
            ...
            .prepend('<div class="app-backdrop backdrop-sidebar"></div>');
    }
    render() {
            ...
            <div>
                ...
                >
                    ...
                    >
                        <ul className="menu">
                            ...
                            <li
                                style={
                                    !this.state.isShowAgencyGeneral
                                        ? { display: "none" }
                                        : {}
                                }
                                className={
                            ...
                            this.state.userType === "Fixer" ? (
                                <li
                                    style={
                                        !this.state.isStatisticalBranch
                                            ? { display: "none" }
                                            : {}
                                    }
                                    className={
                            ...
                            this.state.userType === "Fixer" ? (
                                <li
                                    style={
                                        !this.state.isStatisticalBranch1
                                            ? { display: "none" }
                                            : {}
                                    }
                                    className={
                ...
                >
                  ...
                  <span className="title">{this.state.userRole==="SuperAdmin" && this.state.userType==="Factory" ?"Xem đơn vỏ":"Xem đơn hàng"}</span>
                                ...
                                <li
                                    style={
                                        !this.state.isShowTurnbackOrder
                                            ? { display: "none" }
                                            : {}
                                    }
                                    className={
                            ...
                            <li
                                style={
                                    !this.state.isShowPriceListSetting
                                        ? { display: "none" }
                                        : {}
                                }
                                className={
                        ...
                        <ul className="topbar-btns">
                            <li className="dropdown">
                                ...
                                <div className="dropdown-menu dropdown-menu-right">
                                    ...
                                    >
                                        <i className="ti-power-off"></i> Đăng
                                        xuất
                                    </a>
                                    <a
                                        className="dropdown-item"
